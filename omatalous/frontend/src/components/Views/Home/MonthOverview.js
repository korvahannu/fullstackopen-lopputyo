...
const MonthOverview = ({title, earnings, spendings}) => {
    ...
    return (
        <Box sx={{ mr:2, border: '1px solid lightgrey', borderRadius: 1, width: '350px', padding: 2, '&:hover': { cursor: 'pointer', backgroundColor: '#f7f7f7' } }}>
            ...
            <Box sx={{ display: 'flex' }}>
                <Typography variant='body2'><KeyboardArrowUpIcon sx={{ position: 'relative', top: '5px', mr: 0.5 }} /> You have earned</Typography>
                <Box sx={{ flexGrow: 1 }} />
                <Typography variant='body2' sx={{ position: 'relative', top: '10px', mr: 0.5, color: 'green' }} >{earnings} €</Typography>
            </Box>
            <Box sx={{ display: 'flex' }}>
                <Typography variant='body2'><KeyboardArrowDownIcon sx={{ position: 'relative', top: '5px', mr: 0.5 }} /> You have spent</Typography>
                <Box sx={{ flexGrow: 1 }} />
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Box sx={{ flexGrow: 1 }} />
                <Typography variant='body2' sx={{ position: 'relative', top: '10px', mr: 0.5, color: 'green' }} >{Math.round(earnings-spendings * 100) /100} €</Typography>
            </Box>
        </Box>
    );
};
